...
#plot les kmeans en fonction des inerties inter classes 
...
# + grand saut entre 2 et 3 : on retient 3 classes et reboucle avec CAH.
head(df_x)
...
# On arrive a visionner les 3 classes qui se dégagent en fonction 
# des deux variables qui contribuent le plus aux 2 1eres dim de l'ACP
